...
function getArg()
    ...
    local arg="duration="..tostring(duration).."%tequila%".."mode=".."0".."%tequila%".."sampleRate="..sampleRate.."%tequila%".."sourcePath="..sourcePath.."%tequila%".."desPath="..desPath.."%tequila%".."pitches="..pitches.."%tequila%"
