...
function getArg()
    ...
    local arg="duration="..tostring(duration).."%tequila%".."mode=".."2".."%tequila%".."sampleRate="..sampleRate.."%tequila%".."sourcePath="..sourcePath.."%tequila%".."desPath="..desPath.."%tequila%".."pitches="..pitches.."%tequila%"
